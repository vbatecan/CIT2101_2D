...
namespace CaseClosed.Editor
{
    ...
    public static class MainMenuSceneBuilder
    {
        ...
        public static void BuildSceneHierarchy()
        {
            ...
            SetupRectTransform(inspectPanel, new Vector2(0.2f, 0.15f), new Vector2(0.8f, 0.85f), Vector2.zero, Vector2.zero);
            ...
            SetupRectTransform(inspImg, new Vector2(0.2f, 0.2f), new Vector2(0.8f, 0.8f), Vector2.zero, Vector2.zero);
