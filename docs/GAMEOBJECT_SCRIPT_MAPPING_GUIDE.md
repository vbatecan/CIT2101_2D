...
| **`Character_Suspect_Left`** | Left person getting interrogated | `SpriteRenderer` | [`CharacterDisplay.cs`](file:///C:/Users/Andrei/Projects/CIT2101_2D/Assets/Scripts/Gameplay/CharacterDisplay.cs) | Set `Character Slot = PrimarySuspect`. Assign `Character Sprite Renderer`. |
| **`Character_Suspect_Right`** | Right person getting interrogated | `SpriteRenderer` | [`CharacterDisplay.cs`](file:///C:/Users/Andrei/Projects/CIT2101_2D/Assets/Scripts/Gameplay/CharacterDisplay.cs) | Set `Character Slot = SecondarySuspect`. Assign `Character Sprite Renderer`. |
